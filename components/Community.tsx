...
const Community = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-12 text-white py-12 lg:py-20 px-4 mt-12">
         <p className="text-3xl md:text-3xl lg:text-5xl font-bold">Your Path to an Exclusive Betting Community</p>
         <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-12">
            ...
            <div className="flex flex-col items-start justify-start w-full lg:w-[380px] text-[#a9c0ff] bg-[#161B22] border-[1px] border-gray-800 px-4 rounded-xl h-[360px] hover:delay-300 hover:bg-[#1A1931] hover:cursor-pointer transition-all duration-200 ease-in-out pt-8 gap-2">
                <FaDiscord size={40}/>
                <p className="text-slate-50 text-xl lg:text-2xl font-bold mt-2">Join our community of bettors</p>

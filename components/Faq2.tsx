...
const Faq = () => {
  return (
    <div className="mt-20 lg:mt-40 scroll-smooth bg-[#00030F]">
        <section className="flex flex-col gap-6 items-center mb-10 text-center p-2">
            ...
            <p className="text-slate-50 w-full lg:text-xl">Have any further questions? Contact us at <span className="text-[#9DC5E5]">contact@systemsacademy.com</span></p>
        </section>
        ...
        <div className="flex justify-center gap-6 w-full p-4 text-slate-50 text-base md:text-lg lg:text-xl">
            ...
            <AccordionItem  className="border-none p-4  rounded-2xl" value={'question 7'}>
                <AccordionTrigger className="text-base lg:text-xl text-left">What if I don&apos;t have a company name or URL yet?</AccordionTrigger>
            ...
            <AccordionItem  className="border-none p-4  rounded-2xl" value={'question 5'}>
                <AccordionTrigger className="text-base lg:text-xl text-left">When can I expect to have my website ready?</AccordionTrigger>
                    <AccordionContent className="text-base lg:text-lg mt-6 flex flex-col gap-2">
            ...
            <AccordionItem  className="border-none p-4  rounded-2xl" value={'question 6'}>
                <AccordionTrigger className="text-base lg:text-xl text-left">Can you redesign an existing website?</AccordionTrigger>
                    <AccordionContent className="text-base lg:text-lg mt-6 flex flex-col gap-2">

...
const Features = () => {
  return (
    <div className="flex flex-col lg:mt-20 items-center w-full z-30 px-4">
        ...
        <div className="flex flex-col items-center pt-20 bg-gradient-to-b from-[#a9c0ff] to-[#1D4ED8] rounded-xl lg:w-[72%] gap-4 mt-16 lg:mt-24 px-4">

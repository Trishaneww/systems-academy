  ...
  return (
    <div className="mt-20 lg:mt-40 scroll-smooth bg-[#00030F]">
        <section className="flex flex-col gap-6 items-center mb-10 text-center p-2">
            <h1 className="text-slate-50  text-3xl md:text-5xl lg:text-6xl font-semibold">Questions and Answers</h1>
            <p className="text-slate-50 w-full lg:text-xl">Find the answers to your questions here</p>
        </section>

        <div className="flex justify-center gap-6 w-full p-4 text-slate-50">

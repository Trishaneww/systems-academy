    ...
    <div className="flex flex-col xl:justify-center xl:items-start gap-12 px-6 w-full bg-[#0C1117] footer py-20">
        ...
        <section className="flex gap-12 items-start flex-wrap">
            ...
            <div className="flex flex-col gap-2 text-slate-50 ">
                ...
                <a href="mailto:hydraguardconstruction@gmail.com" className="text-base" target="_blank">systemsacademy@gmail.com</a>
                <a href="https://www.instagram.com/figmentstudioss" className="text-base" target="_blank">@thesystemsacademy</a>
            </div>
        </section>
    </div>
  )

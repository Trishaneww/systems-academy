...
const ContactHero = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full bg-[#00030F] text-slate-50 overflow-hidden px-6">
      ...
      <div className="w-[85%] lg:w-[50%] h-[50%] bg-gradient-to-r from-[#86a6ff] to-[#1D4ED8] rounded-full absolute z-1 top-[70%] left-[50%] translate-x-[-50%] translate-y-[-50%] blur-[90px] -rotate-12"></div>
      ...
      <form className="w-full lg:w-1/3 xl:w-3/6 max-w-[700px] h-[600px] flex flex-col items-center gap-4 mt-12 bg-[#3838382f] rounded-lg py-12 backdrop-blur-3xl" onSubmit={sendEmail}>
        ...
        <div className="flex flex-col items-start w-5/6 gap-2">
            ...
            <input 
              ...
              className="w-full h-[44px] p-2 rounded-md outline-none text-slate-950 bg-[#38383825] backdrop-blur-3xl placeholder:text-white"/>
          </div>
        ...
        <div className="flex flex-col items-start w-5/6 gap-2">
            ...
            <input 
              ...
              name="phone" 
              placeholder="Email" 
              className="w-full h-[44px] p-2 rounded-md outline-none text-slate-950 backdrop-blur-3xl bg-[#38383825] placeholder:text-white"/>
          </div>
          ...
          <div className="flex flex-col items-start w-5/6 gap-2">
            ...
            <textarea placeholder="Write your question here" name="message" className="w-full h-[200px] p-2 rounded-md outline-none backdrop-blur-3xl bg-[#38383825] placeholder:text-white"/>
          </div>      
